...
class StartblogScreen extends StatefulWidget {
  @override
  _StartblogScreenState createState() => _StartblogScreenState();
}

class _StartblogScreenState extends State<StartblogScreen> {
  @override
